...
import { Server, StdioServerTransport } from '@modelcontextprotocol/sdk/dist/esm/server/index.js';
import type { CallToolRequest, ListToolsRequest } from '@modelcontextprotocol/sdk/dist/esm/shared/protocol.js';
